...
export class CornerLayout {
    ...
    renderResults() {
        ...
        apps.forEach((app, localIndex) => {
            ...
            const icon = platedAppIcon(app.get_icon(), Math.round(16 * this.theme.scale), this.theme.surface, {platesEnabled: this.theme.appIconPlates, extraStyle: 'margin-right: 8px;'});
