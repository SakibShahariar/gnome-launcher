...
export class HeroBannerLayout {
    ...
    _renderApps() {
        ...
        apps.forEach((app, localIndex) => {
            ...
            const icon = platedAppIcon(app.get_icon(), Math.round(16 * this.theme.scale), this.theme.surface, {extraStyle: 'margin-right: 10px;'});
    ...
    _renderWindowResults() {
        ...
        this._modeResults.slice(0, MAX_RESULTS).forEach((item, index) => {
            ...
            const iconColor = selected
                ...
                : this.theme.on_surface_variant;
            const icon = item.app
                ? platedAppIcon(item.app.get_icon(), Math.round(16 * this.theme.scale), this.theme.surface, {extraStyle: 'margin-right: 10px;'})
