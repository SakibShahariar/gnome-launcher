...
export class HeroBannerLayout {
    ...
    buildUI() {
        ...
        const searchOpacity = Math.min(Math.max(this.theme.opacity, 0.15), 0.55);
        const searchRow = new St.BoxLayout({
            ...
            style: `background-color: ${withOpacity(this.theme.surface, searchOpacity)}; ` +
                   ...
                   `border: 1px solid ${withOpacity(this.theme.outline_variant, 0.15)};`,
        });
        ...
        for (const [modeId, iconName, , enabled] of MODES) {
            ...
            const circle = new St.Bin({
                ...
                style: active
                    ...
                    : `background-color: ${withOpacity(this.theme.surface, 0.15)}; ` +
