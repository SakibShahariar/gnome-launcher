...
export class HotkeyLayout {
    ...
    renderResults() {
        ...
        apps.forEach((app, localIndex) => {
            ...
            number.set_width(18);
            const icon = platedAppIcon(app.get_icon(), Math.round(18 * this.theme.scale), this.theme.surface, {platesEnabled: this.theme.appIconPlates, extraStyle: 'margin: 0 10px;'});
