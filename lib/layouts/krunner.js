...
export class KrunnerLayout {
    ...
    renderResults() {
        ...
        apps.forEach((app, localIndex) => {
            ...
            const icon = platedAppIcon(app.get_icon(), Math.round(18 * this.theme.scale), this.theme.surface, {platesEnabled: this.theme.appIconPlates, extraStyle: 'margin-right: 12px;'});
